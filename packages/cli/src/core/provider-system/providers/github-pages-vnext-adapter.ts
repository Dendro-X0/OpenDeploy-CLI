/**
 * Adapter to use the vNext @opendeploy/provider-github-pages within the
...
import { GithubPagesProvider as VNextProvider } from '@opendeploy/provider-github-pages'

export class GithubPagesVNextAdapter implements LegacyProvider {
  public readonly id: string = 'github-pages'
  ...
  // GitHub Pages uses git/gh-pages; keep validateAuth a no-op for MVP
  public async validateAuth(_cwd: string): Promise<void> { return }

  // No explicit linking for GH Pages; just return the provided or inferred project ref
